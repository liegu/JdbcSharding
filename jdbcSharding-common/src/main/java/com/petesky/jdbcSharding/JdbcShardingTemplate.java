...
/**
 * Desc:mast-slave JdbcTemplate
 * 修改自spring-jdbc JdbcTemplate
 * 在获取dataSource时增加读写分离
 * Created by liegu.pete on 2016/4/18 下午4:22.
 */
public class JdbcShardingTemplate extends JdbcAccessor implements JdbcShardingOperations {
     ...
     */
    public JdbcShardingTemplate(DataSource dataSource) {
     ...
     */
    public JdbcShardingTemplate(DataSource dataSource, boolean lazyInit) {
        setDataSource(dataSource);
    ...
    public <T> T execute(ConnectionCallback<T> action,boolean isWrite) throws DataAccessException {
        ...
        try {
            ...
            if (this.nativeJdbcExtractor != null) {
                ...
                conToUse = createConnectionProxy(con,ds);
            }
...
//     * @see #execute(ConnectionCallback,boolean isWrite)
//     * @see #applyStatementSettings
//     */
    protected Connection createConnectionProxy(Connection con,DataSource dataSource) {
        return (Connection) Proxy.newProxyInstance(
                ConnectionProxy.class.getClassLoader(),
                new Class[] {ConnectionProxy.class},
                new CloseSuppressingInvocationHandler(con,dataSource));
    }
    ...
    public <T> T execute(StatementCallback<T> action,boolean isWrite) throws DataAccessException {
        Assert.notNull(action, "Callback object must not be null");
        ...
        try {
            ...
            applyStatementSettings(stmt,ds);
    ...
    public void execute(final String sql,boolean isWrite) throws DataAccessException {
        ...
        execute(new ExecuteStatementCallback(),isWrite);
    }
    ...
    public int update(final String sql) throws DataAccessException {
        ...
        return execute(new UpdateStatementCallback(),true);
    }
    ...
    public int[] batchUpdate(final String[] sql) throws DataAccessException {
        ...
        return execute(new BatchUpdateStatementCallback(),true);
    }
    ...
    public <T> T execute(PreparedStatementCreator psc, PreparedStatementCallback<T> action,boolean isWrite)
    ...
    public <T> T execute(String sql, PreparedStatementCallback<T> action,boolean isWrite) throws DataAccessException {
...
//    }
    ...
    public Long insert(PreparedStatementCreator psc) throws DataAccessException {
        return insert(psc, (PreparedStatementSetter) null);
    }
    
    protected Long insert(final PreparedStatementCreator psc, final PreparedStatementSetter pss)
            throws DataAccessException {

        logger.debug("Executing prepared SQL insert");
        return execute(psc, new PreparedStatementCallback<Long>() {
            public Long doInPreparedStatement(PreparedStatement ps) throws SQLException {
                try {
                    ...
                    if (logger.isDebugEnabled()) {
                        logger.debug("SQL update affected " + row + " rows,id:"+id);
                    }
                    return id;
                }
                finally {
    ...
    public <T> T execute(CallableStatementCreator csc, CallableStatementCallback<T> action,boolean isWrite)
            throws DataAccessException {
    ...
    public <T> T execute(String callString, CallableStatementCallback<T> action,boolean isWrite) throws DataAccessException {
        return execute(new SimpleCallableStatementCreator(callString), action,isWrite);
    }
     ...
     */
    protected void applyStatementSettings(Statement stmt,DataSource dataSource) throws SQLException {
...
//     */
    ...
    private class CloseSuppressingInvocationHandler implements InvocationHandler {
        ...
        public CloseSuppressingInvocationHandler(Connection target,DataSource dataSource) {
            this.target = target;
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            try {
                ...
                if (retVal instanceof Statement) {
                    applyStatementSettings(((Statement) retVal),dataSource);
                }
